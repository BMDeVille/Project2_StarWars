...
public class starwartest {
	...
	public void returnUsers() {
		...
		User u = new User("test121","f1","l1","test111@test.com","test111",new Timestamp(date.getTime()),"secans",pt.get(0));
		ds.insertUser(u);
		...
		u1.setAbout("test2");
		ds.updateUser(u1);
		ds.insertUser(new User("test2122","f2","l2","test21232@test.com","test1233",new Timestamp(date.getTime()),"secans",pt.get(1)));
		User u2 = ds.selectByUsername("QWE");
		...
		assertNotNull(ds.selectByUsername("test121"));
		ds.deleteUser(u1);
